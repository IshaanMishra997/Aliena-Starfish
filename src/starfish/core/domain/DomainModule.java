...
public class DomainModule extends CommandModule {
	 ...
	 * @return r
	 */
	public FieldManager2D getFieldManager() {
...
//	    return Starfish.averaging_module.getFieldCollection(var_name);
	...
	public void start() {
		...
		/*
		 * TODO: this is currently getting called twice, once on <domain> and then by
		 * <starfish> (after boundaries are loaded
		 */
	...
	/*
	 * TODO: this is not very efficient since things like node volumes get
	 * recomputed even if they don't need to be
	 */
	...
	public Field2D getPhi(Mesh mesh) {
		return getPhi().getField(mesh);
	}
	 ...
	 * @return
	 */
	public Field2D getRho(Mesh mesh) {
		return getRho().getField(mesh);
	}
	 ...
	 * @return
	 */
	public Field2D getEfi(Mesh mesh) {
		return getEfi().getField(mesh);
	}
	 ...
	 * @return
	 */
	public Field2D getEfj(Mesh mesh) {
		return getEfj().getField(mesh);
	}
	 ...
	 * @return
	 */
	public Field2D getBfi(Mesh mesh) {
		return getBfi().getField(mesh);
	}
	 ...
	 * @return
	 */
	public Field2D getBfj(Mesh mesh) {
		return getBfj().getField(mesh);
	}
	...
	public Field2D getP(Mesh mesh) {
		return getPressure().getField(mesh);
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getPhi() {
		return field_manager.getFieldCollection("phi");
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getRho() {
		return field_manager.getFieldCollection("rho");
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getEfi() {
		return field_manager.getFieldCollection("efi");
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getEfj() {
		return field_manager.getFieldCollection("efj");
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getBfi() {
		return field_manager.getFieldCollection("bfi");
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getBfj() {
		return field_manager.getFieldCollection("bfj");
	}
	 ...
	 * @return
	 */
	public FieldCollection2D getPressure() {
