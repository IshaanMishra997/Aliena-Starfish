...
public class Constants 
{
    ...
    static public final double H = 6.626070e-34;	    /* J*s, Planck's constant */
    ...
    static public final double EVtoJ = QE;		//electron volts in joules
    static public final double JtoEV = 1.0/EVtoJ;
